...
def get_callbacks(num_batches):
    ...
    cfg_ck = CheckpointConfig(save_checkpoint_steps = cfg.SOLVER.CHECKPOINT_PERIOD * num_batches,
                              keep_checkpoint_max=20, append_info=ckpt_append_info)
...
def train_net():
    ...
    # dont know why after eval will bug, maybe something is wrong about the "net.set_train(False)" in do eval()
