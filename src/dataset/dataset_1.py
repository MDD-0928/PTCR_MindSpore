...
from .dataset_define_1 import (Market1501, DukeMTMCreID, MSMT17, CUHK03)
...
class RandomIdentitySampler(ds.Sampler):  # torch original
    ...
    def __init__(self, data_source, batch_size, num_instances):
        ...
        for index, (_, pid, camid, trackid) in enumerate(self.data_source):
...
def dataset_creator(
    ...
    if mode == 'train':
        ...
        if isinstance(device_num, int) and device_num > 1:
            data_set = ds.GeneratorDataset(
                dataset_, ['img', 'pid', 'camid', 'trackid'],
    ...
    data_set = ds.GeneratorDataset(dataset_, ['img', 'pid', 'camid', 'trackid'],
